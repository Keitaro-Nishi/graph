...
<div class="container" align="center">
	@if (Auth::user()->citycode != 00000) <input id="btn_del" type="button"
		class="btn btn-default" value="選択行の削除" onclick="drow()"> <input
		id="btn_ins" type="button" class="btn btn-default" value="施設登録"
		onclick="insert()"> @endif <input id="btn_modal" type="button"
