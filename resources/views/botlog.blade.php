			...
			<div class="modal-body">
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea type="text" class="form-control" id="dia_contents" value="{{$botlog->contents}}" rows='5' readonly></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="dia_return">回答</label>
						<div class="col-sm-10">
							<textarea type="text" class="form-control" id="dia_return" value="{{$botlog->return}}" rows='5' readonly></textarea>
						</div>
					</div>
					@endforeach
				</form>
