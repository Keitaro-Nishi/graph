...
class FacilityController {
	public function index(Request $request) {
		...
		if ($cityCD == "00000") {
			...
			->get();
			*/
			$facilities = Facility::where('facility.citycode', $cityCD)->leftJoin('genre as class1', function ($join){
				...
				$join->on('facility.genre2', '=', 'class2.gid2')->where('class2.gid1', facility.genre1);
			})
		...
		$mediums= Genre::where('citycode', $cityCD)->where('bunrui', 2)/*->where('gid1', $gid1)*/->orderBy('gid2', 'ASC')->get();
